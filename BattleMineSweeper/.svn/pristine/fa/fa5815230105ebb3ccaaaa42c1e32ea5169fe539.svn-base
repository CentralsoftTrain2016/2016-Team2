...
public enum PLAYMODE {
	SINGLE_MODE("1"){
		...
		public void prepareNextTurn(GAMEID gameID, Connection con) throws SQLException,ClassNotFoundException{
		}
	...
	public abstract void prepareNextTurn(GAMEID gameID, Connection con) throws SQLException,ClassNotFoundException ;
